...
class GameScene extends Phaser.Scene {
  ...
  initializeBackground() {
    this.bg = this.add
      .tileSprite(0, 50 + this.top, 15000, 1599, "bg")
      .setScale(0.313)
      .setOrigin(0, 0)
      .setDepth(2)
      .setAlpha(0.9);
    this.front = this.add
      .tileSprite(0, 300 + this.top, 15000, 1599, "front")
      .setScale(0.313)
      .setDepth(6);
  }
  ...
  addObstackle() {
    ...
    if (honeyPotOn) {
      setTimeout(() => {
        let obstacle = this.physics.add.image(1200, 440 + this.top, "honeypot");
        obstacle
          .setVelocityX(-228 * this.speed)
          .setScale(0.3)
          .setDepth(4);
    ...
    if (selectElement == 1) {
      let obstacle = this.physics.add.sprite(1200, 340 + this.top, "bird");
      obstacle.anims.play("bird");
      if (this.state == 4) {
        this.obstacle.setVelocityX(0);
      } else {
        obstacle.setVelocityX(-300 * this.speed);
      }
      ...
      this.physics.add.collider(
        ...
        this.colidDetect,
        () => {
          obstacle.setVelocityX(-250 * this.speed);
      ...
      let obstacle = this.physics.add.image(1200, 450 + this.top, "rock");
      obstacle
        .setVelocityX(-228 * this.speed)
        .setScale(0.5)
        .setDepth(4);
